      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <Link
            ...
            className="relative p-2 rounded-full bg-white border-2 border-transparent transition-all duration-300 group-hover:border-purple-500/80 group-hover:bg-gradient-to-r from-purple-500/20 to-indigo-500/20"
            aria-label={`View ${product.name}`} // Add aria-label for accessibility
          >
            <AiOutlineEye className="text-2xl text-gray-800 transition-colors duration-300 group-hover:text-purple-600" />
