...
//       style={{ fontFamily: "'Poppins', sans-serif" }} // ✅ Clean modern font
//     >
//       {/* Gradient Background */}
//       <div
...
//             style={{
//               color: "#ffffff",
//               textShadow: "2px 4px 10px rgba(0,0,0,0.5)", // ✅ makes text pop
//               fontFamily: "'Montserrat', sans-serif",
//               letterSpacing: "1px",
//             }}
//           >
...
//               color: "#f5f5f5",
//               opacity: 0.9,
//               textShadow: "1px 2px 6px rgba(0,0,0,0.4)", // ✅ subtle glow
...
//       {/* Navbar */}
//       <nav className="relative z-30 w-full flex items-center justify-between px-6 py-4">
//         {/* ✅ Brand name with fallback visibility */}
//         <div
//           className="text-2xl font-extrabold tracking-wide relative"
